...
// DEVEUI: XXXXXXXXXXXXXXXX (Reversed to LSB for LMIC) Get from TTN create new end evice
static const u1_t PROGMEM DEVEUI[8] = { 0xXX, 0xXX, 0xXX, 0xXX, 0xXX, 0xXX, 0xXX, 0xXX };
void os_getDevEui(u1_t* buf) { memcpy_P(buf, DEVEUI, 8); }

// APPKEY: XXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXX (MSB - No change) Get from TTN create new end evice
