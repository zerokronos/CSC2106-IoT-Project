...
// DEVEUI: 70B3D57ED00768FD (Reversed to LSB for LMIC)
static const u1_t PROGMEM DEVEUI[8] = { 0xFD, 0x68, 0x07, 0xD0, 0x7E, 0xD5, 0xB3, 0x70 };
void os_getDevEui(u1_t* buf) { memcpy_P(buf, DEVEUI, 8); }

// APPKEY: 8E4D5CE28D5EBB38EB8BA844345F1B24 (MSB - No change)
static const u1_t PROGMEM APPKEY[16] = {
  0x8E, 0x4D, 0x5C, 0xE2, 0x8D, 0x5E, 0xBB, 0x38,
  0xEB, 0x8B, 0xA8, 0x44, 0x34, 0x5F, 0x1B, 0x24
};
...
static uint8_t default_node_id = 3;
